		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Worklist_test",
									"targetURL": "#comlinkupwwwestagiarios-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlinkupwwwestagiarios-display": {
								"semanticObject": "comlinkupwwwestagiarios",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.linkup.www.estagiarios",
									"url": sap.ui.require.toUrl("com/linkup/www/estagiarios")
								}
							}
						}
					}
